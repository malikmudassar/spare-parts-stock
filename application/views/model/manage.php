                            ...
                            <table id="demo-dynamic-tables-2" class="table table-middle nowrap">
                                ...
                                <?php for($i=0;$i<count($menu_items);$i++){?>
                                    <tr>
                                        ...
                                        <td></td>
                                        <td>
                                            <a href="<?php echo base_url().'model/edit/'.$menu_items[$i]['id'];?>" class="btn btn-default"><i class="icon icon-pencil"></i></a>
    ...
    function validate(a)
    {
        ...
        swal({
                ...
                closeOnConfirm: false }, function()
            {
                ...
                $(location).attr('href','<?php echo base_url()?>model/delete/'+id);
            }
        );
    }
</script>